...
try:
    stats_handler = MakeRotatingFileHandler(
        "logs/stats.log", backupCount=2, maxBytes=1000
    )
    ...
    logger.warn(
        "Could not set the stats_FileHandler due to a permission error. Don't use both local and docker"
    )
    pass
