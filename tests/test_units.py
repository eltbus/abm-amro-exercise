...
def test_filter_rows_by_country_returns_empty_Dataframe_if_country_not_in_DataFrame(
    personal_info,
):
    """
...
def test_filter_rows_by_country_returns_two_rows_for_countries_AAA_and_BBB(
    personal_info,
):
    """
    TODO: Ejemplo para demostrar que funciona.
...
def test_select_id_and_email_raises_error_if_columns_id_and_email_dont_exist(
    personal_info,
):
    """
    TODO: Ejemplo para demostrar que funciona.
...
def test_drop_credit_cardnumber_raises_error_if_column_cc_n_doesnt_exist(
    financial_info,
):
    """
    TODO: Ejemplo para demostrar que funciona.
...
def test_inner_join_returns_DataFrame_with_expected_columns(
    personal_info, financial_info, col
):
    """
    TODO: Ejemplo para demostrar que funciona.
    """
...
@pytest.mark.parametrize(
    "col", ["client_identifier", "bitcoin_address", "credit_card_type"]
)
def test_rename_columns_returns_DataFrame_with_expected_columns(
    personal_info, financial_info, col
):
    """
    TODO: Ejemplo para demostrar que funciona.
